...
class ParseResults:
    """Structured parse source, to provide multiple means of access to
    the parsed data:

    - as a list (``len(source)``)
    - by list index (``source[0], source[1]``, etc.)
    - by attribute (``source.<results_name>`` - see :class:`ParserElement.set_results_name`)
    ...
    class List(list):
        """
        Simple wrapper class to distinguish parsed list source that should be preserved
    ...
    def haskeys(self) -> bool:
        ...
        code that looks for the existence of any defined source names."""
    ...
    def pop(self, *args, **kwargs):
        ...
        semantics and pop the corresponding value from any defined source
        ...
        Example::
            ...
            # removed from list form of source)
    ...
    def insert(self, index, ins_string):
        ...
        Example::
            ...
            # use a parse action to insert the parse location in the front of the parsed source
    ...
    def clear(self):
        """
        Clear all elements and source names.
        """
        del self._toklist[:]
        self._tokdict.clear()
    ...
    def as_list(self) -> list:
        """
        Returns the parse source as a nested list of matching tokens, all converted to strings.
    ...
    def as_dict(self) -> dict:
        """
        Returns the named parse source as a nested dictionary.
    ...
    def get_name(self):
        r"""
        Returns the source name for this token expression. Useful when several
    ...
    def pprint(self, *args, **kwargs):
        """
        Pretty-printer for parsed source as a list, using the
    ...
    def from_dict(cls, other, name=None) -> "ParseResults":
        ...
        name-value relations as source names. If an optional ``name`` argument is
