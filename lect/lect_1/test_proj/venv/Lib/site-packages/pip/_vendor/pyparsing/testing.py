...
class pyparsing_test:
    ...
    class TestParseResultsAsserts:
        """
        A mixin class to add parse source assertion methods to normal unittest.TestCase classes.
        """
        ...
        def assertParseResultsEquals(
            ...
            and compare any defined source names with an optional ``expected_dict``.
            """
        ...
        def assertRunTestResults(
            ...
            # do this last, in case some specific test source can be reported instead
            self.assertTrue(
